...
parameters.indices = logical(tril(ones(parameters.number_of_sources), -1));
...
% Output
parameters.loop_list.things_to_save.average.dir = {[parameters.dir_exper 'fluorescence analysis\'],'data_type', '\', 'transformation', '\', 'mouse', '\instances reshaped\'};
...
parameters.loop_list.things_to_save.std_dev.dir = {[parameters.dir_exper 'fluorescence analysis\'],'data_type', '\', 'transformation', '\', 'mouse', '\instances reshaped\'};
...
for mousei = 1:numel(parameters.mice_all)
...
%% Are accel/decel transitons different than continued walk? 
